...
public class MainFrame extends javax.swing.JFrame {
    ...
    /**
    * Set controls and menus configuration for activated view.
    * Must be overwritten by end application designer.
    */
   ...
   /**
    * Set controls and menus configuration for activate view and for edit selected object.
    * Must be overwritten by end application designer.
    */
   ...
   /**
    * Set controls for no seleted Views (if all documents closed).
    * Must be overwritten by end application designer.
    */
