...
public class DocumentManager {
    ...
    /**
     * find path and filename. open document.
     */
    public static boolean openDocument(com.github.dmogn.framework.filechooser.FileChooserOption extensions[], String defaultDirectory) {
        try {
            javax.swing.JFileChooser ch = new javax.swing.JFileChooser();
            com.github.dmogn.framework.filechooser.FileChooserOption defaultExtension = null;
            for (int i = 0; i < extensions.length; i++) {
                com.github.dmogn.framework.filechooser.CustomFileFilter filter = new com.github.dmogn.framework.filechooser.CustomFileFilter(extensions[i]);
                if (i == 0) {
    ...
    /**
     * find path and filename. save document.
     */
    public static void saveDocument(com.github.dmogn.framework.filechooser.FileChooserOption extensions[], String defaultDirectory) {
        try {
    ...
    /**
     * Close (without save) old document. Create copy of the document. Save new
     * document.
     */
    public static void saveAsDocument(com.github.dmogn.framework.filechooser.FileChooserOption extensions[], String defaultDirectory) {
        try {
            if (currentDocument == null) {
                return;
            }
            ...
            javax.swing.JFileChooser ch = new javax.swing.JFileChooser();
            com.github.dmogn.framework.filechooser.CustomFileFilter filter = new com.github.dmogn.framework.filechooser.CustomFileFilter(extensions[0]);
            ch.setFileFilter(filter);

            for (int i = 1; i < extensions.length; i++) {
                com.github.dmogn.framework.filechooser.CustomFileFilter filter_additional
                        = new com.github.dmogn.framework.filechooser.CustomFileFilter(extensions[i]);
            ...
            if (ch.showSaveDialog(framework) == javax.swing.JFileChooser.APPROVE_OPTION) {
                ...
                if (ch.getFileFilter() instanceof com.github.dmogn.framework.filechooser.CustomFileFilter) {
                    com.github.dmogn.framework.filechooser.CustomFileFilter selectedFilter
                            = (com.github.dmogn.framework.filechooser.CustomFileFilter) ch.
                                    getFileFilter();
    ...
    /**
     * Check document for modified. Close document. Create new document.
     */
